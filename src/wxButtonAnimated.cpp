...
wxButtonAnimated::wxButtonAnimated(wxWindow *parent,
                  wxWindowID id,
...
void wxButtonAnimated::doAnimations() {
...
void wxButtonAnimated::animate(double fntStart, double fntStop, double clrStart, double clrStop) {
...
wxSize wxButtonAnimated::getBestSize(const wxString &str) const {
    wxScreenDC dc;
